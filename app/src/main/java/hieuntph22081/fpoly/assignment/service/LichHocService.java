...
public class LichHocService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        for (User_MonHoc um : user_monHocs) {
                lichHocs.addAll(lichHocDAO.getLichHocByMaMon(um.getMaMon()));
        }
        Intent broadcastIntent = new Intent();
        broadcastIntent.setAction("hieuntph22081.fpoly.assignment.LICH_HOC");
        Bundle bundle = new Bundle();
        bundle.putSerializable("lichHoc", (Serializable) lichHocs);
